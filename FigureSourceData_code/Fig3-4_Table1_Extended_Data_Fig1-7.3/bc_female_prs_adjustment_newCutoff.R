setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/breast_0.95")

#------------------- Read in data -----------------------

mega_profile <- read.table("mega_breast_female.profile", header=T, stringsAsFactors=F)
megaex_profile <- read.table("megaex_breast_female.profile", header=T, stringsAsFactors=F)
mega1a_profile <- read.table("meg_a1_a_breast_female.profile", header=T, stringsAsFactors=F)
mega1b_profile <- read.table("meg_a1_b_breast_female.profile", header=T, stringsAsFactors=F)
megc_profile <- read.table("meg_c_breast_female.profile", header=T, stringsAsFactors=F)
megd_profile <- read.table("meg_d_breast_female.profile", header=T, stringsAsFactors=F)
mege_profile <- read.table("meg_e_breast_female.profile", header=T, stringsAsFactors=F)
megx1_profile <- read.table("meg_x1_breast_female.profile", header=T, stringsAsFactors=F)
...
all_batch_profile <- read.table("all_batch_female.profile", header=T, stringsAsFactors=F)
...
plot(density(mega_score, adjust=2), col="black", xlim=c(-2.5, 1.8), ylim=c(0, 0.9), xlab="PRS score", lty="dotted", main="Density ~ PRS score of BreastCA in Female")

par(mar=c(3.5,3.5,1,1))
plot(density(mega_score, adjust=2), col="black", xlim=c(-2.5, 1.8), ylim=c(0, 0.9), xlab="", ylab="",lty="dotted", main="")
title(xlab="PRS score", line=2, cex.lab=1)
...
#README file contains how prs_score_breast_covariates_chip.tsv is created
setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/breast_0.95")
score_pheno <- read.table("prs_score_breast_covariates_chip_female.tsv", header=T, stringsAsFactors=F)
...
plot(density(age20_score, adjust=2), col="black", xlim=c(-2.5, 1.8), ylim=c(0, 0.9), xlab="PRS score", lty="dotted", main="Density ~ PRS score of BreastCA in female")

par(mar=c(3.5,3.5,1,1))
plot(density(age30_score,adjust=2), col="black", xlim=c(-2.5, 1.8), ylim=c(0, 0.9), xlab="", ylab="", lty="dotted", main="")
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-2.5, 1.8), ylim=c(0, 0.9), main="Female BreastCA PRS Score Analysis")
...
text(1, 0.8, paste0("r=", round(corr,4)))
...
plot(std_score, odds.adj, xlab="Standardized PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-4, 4), ylim=c(0,0.4), main="Female BreastCA PRS Score Analysis")
lines(density(std_score, adjust=2), col="darkblue")
abline(lm(odds.adj~std_score), col="red")
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(2.5, 0.25, paste0("r=", round(corr, 4)))
...
mylogit <- glm(BRCA95~std_score+Age+Race+chip, data=score_pheno, family=binomial)  #Build model
...
plot(std_score, pred_odds*adj, xlab="Standardized PRS score", ylab=paste0("predicted odds (x", adj, ")"), xlim=c(-4.5, 4.5), ylim=c(0,2.5), main="Female BreastCA PRS Score Analysis")
lines(density(std_score, adjust=2), col="darkblue")
...
plot(quan_cases.df[,1], quan_cases.df[,2]*adj, xlab="Standardized PRS score", ylab=paste0("Pred Odds (x", adj, ")"), xlim=c(-4.5, 4.5), ylim=c(0,0.4), main="Female BreastCA PRS Score Analysis")
...
mylogit <- glm(BRCA95~std_score+Age+chip, data=white_score_pheno, family=binomial)  #Build model
summary(mylogit)   #View the model
#confint(mylogit)         #confident interval of predictors
...
plot(density(white_score, adjust=2), col="black", xlim=c(-2.5, 1.8), ylim=c(0, 0.9), xlab="PRS score", lty="dotted", main="Density ~ PRS score of BreastCA")

par(mar=c(3.5,3.5,1,1))
plot(density(white_score, adjust=2), col="black", xlim=c(-2.5, 1.8), ylim=c(0, 0.9), xlab="",ylab="", lty="dotted", main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab="Density", line=2, cex.lab=1.0)

lines(density(black_score, adjust=2), lty="dotted", col="purple")
lines(density(asian_score, adjust=2), lty="solid", col="green")
lines(density(other_score, adjust=2), lty="dotted", col="red")
lines(density(unknown_score, adjust=2), lty="solid", col="blue")
...
ltys <- c("dotted","dotted","solid","dotted","solid")  # one lty for each column
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-2.5, 1.8), ylim=c(0, 0.9), main="White BreastCA PRS Score Analysis")

par(mar=c(3.5,3.5,1,1))
plot(prs_score, odds.adj, xlab="", ylab="", xlim=c(-2.5, 1.8), ylim=c(0, 0.9), main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-2.5, 1.8), ylim=c(0, 0.9), main="Black BreastCA PRS Score Analysis")
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-2.5, 1.8), ylim=c(0, 0.9), main="Asian BreastCA PRS Score Analysis")
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-2.5, 1.8), ylim=c(0, 0.9), main="Other BreastCA PRS Score Analysis")
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-2.5, 1.8), ylim=c(0, 0.9), main="Unknown BreastCA PRS Score Analysis")
...
score_pheno_pc_control <- score_pheno_pc[which(score_pheno_pc$BRCA95 == 0),]

pcmod <- lm(PRS ~ PC1 + PC2 + PC3 + PC4, data=score_pheno_pc_control)
summary(pcmod)
#saveRDS(pcmod, "breastC_pc_model.RDS")
...
#write.csv(high.risk, file="above_cutoff_bc.csv", row.names=F, quote=F)
...
#write.csv(above_cutoff.adj, file="high_risk_analysis/above_cutoff_bc.csv", row.names=F, quote=F)
...
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(2.7, -3.8, paste0("r=", round(corr,4)))
...
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(2.5, -4.5, paste0("r=", round(corr,4)))
...
pc_model <- readRDS("breastC_pc_model.RDS")
sample_raw_score <- read.table("pre_GDA_test_merged_large_batch_cleaned_imputed_BreastCA_22samples.sscore", header=F, stringsAsFactor=F)
output_name <- "pre_GDA_test_merged_large_batch_cleaned_imputed_BreastCA_22samples.sscore.adjusted"
...
setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/breast_0.95")
mega_profile <- read.table("mega_breast_female.profile", header=F, stringsAsFactors=F)
megaex_profile <- read.table("megaex_breast_female.profile", header=F, stringsAsFactors=F)
mega1a_profile <- read.table("meg_a1_a_breast_female.profile", header=F, stringsAsFactors=F)
mega1b_profile <- read.table("meg_a1_b_breast_female.profile", header=F, stringsAsFactors=F)
megc_profile <- read.table("meg_c_breast_female.profile", header=F, stringsAsFactors=F)
megd_profile <- read.table("meg_d_breast_female.profile", header=F, stringsAsFactors=F)
mege_profile <- read.table("meg_e_breast_female.profile", header=F, stringsAsFactors=F)
megx1_profile <- read.table("meg_x1_breast_female.profile", header=F, stringsAsFactors=F)
...
nr <- length(Vars) 
legend("topright", rep(Vars, 1), col = colors, lty = ltys, ncol = 1, cex = 0.42)
text(-3.2, 0.35, paste0("BrCa"))
