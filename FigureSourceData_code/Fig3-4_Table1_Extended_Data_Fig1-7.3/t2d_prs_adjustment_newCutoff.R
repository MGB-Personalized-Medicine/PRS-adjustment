setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/t2d_0.95")

#------------------- Read in data -----------------------

mega_profile <- read.table("mega_t2d.profile", header=T, stringsAsFactors=F)
megaex_profile <- read.table("megaex_t2d.profile", header=T, stringsAsFactors=F)
mega1a_profile <- read.table("meg_a1_a_t2d.profile", header=T, stringsAsFactors=F)
mega1b_profile <- read.table("meg_a1_b_t2d.profile", header=T, stringsAsFactors=F)
megc_profile <- read.table("meg_c_t2d.profile", header=T, stringsAsFactors=F)
megd_profile <- read.table("meg_d_t2d.profile", header=T, stringsAsFactors=F)
mege_profile <- read.table("meg_e_t2d.profile", header=T, stringsAsFactors=F)
megx1_profile <- read.table("meg_x1_t2d.profile", header=T, stringsAsFactors=F)
...
output <- "~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/alldiseases_prs_top0.5/t2d_top0.5.csv"
...
plot(density(mega_score, adjust=2), col="black", xlim=c(55, 56.7), ylim=c(0, 3), xlab="PRS score", lty="dotted", main="Density ~ PRS score of T2D")

par(mar=c(3.5,3.5,1,1))
plot(density(mega_score, adjust=2), col="black", xlim=c(55, 56.7), ylim=c(0, 3), xlab="",ylab="", lty="dotted", main="")
...
#README file contains how prs_score_t2d_covariates_chip.tsv is created
setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/t2d_0.95")
score_pheno <- read.table("prs_score_t2d_covariates_chip.tsv", header=T, stringsAsFactors=F)
...
plot(density(male_score, adjust=2), col="red", xlim=c(55, 56.7), ylim=c(0, 3), xlab="PRS score", lty="solid", main="Density ~ PRS score of T2D")

par(mar=c(3.5,3.5,1,1))
plot(density(male_score, adjust=2), col="red", xlim=c(55, 56.7), ylim=c(0, 3), xlab="", ylab="", lty="solid", main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab="Density", line=2, cex.lab=1.0)
...
plot(density(age20_score, adjust=2), col="black", xlim=c(55, 56.7), ylim=c(0, 3), xlab="PRS score", lty="dotted", main="Density ~ PRS score of T2D")

par(mar=c(3.5,3.5,1,1))
plot(density(age30_score, adjust=2), col="black", xlim=c(55, 56.7), ylim=c(0, 3), xlab="", ylab="", lty="dotted", main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab="Density", line=2, cex.lab=1.0)
...
nr <- length(Vars) 
legend("topright", rep(Vars, 1), col = colors, lty = ltys, ncol = 1, cex = 0.55)
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(55, 56.7), ylim=c(0, 3), main="T2D PRS Score Analysis")
...
text(56.4, 2.2, paste0("r=", round(corr,4)))
...
plot(std_score, odds.adj, xlab="Standardized PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-4, 4), ylim=c(0,0.45), main="T2D PRS Score Analysis")
...
mylogit <- glm(T2DM95~std_score+Gender+Age+Race+chip, data=score_pheno, family=binomial)  #Build model
...
std_threshold <- log(2) / log(OR_change_per_prs_sd)   #2 is target raw PRS score cutoff, log is natural logarithm with base e
std_threshold
...
plot(std_score, pred_odds*adj, xlab="Standardized PRS score", ylab=paste0("predicted odds (x", adj, ")"), xlim=c(-4.5, 4.5), ylim=c(0,2.5), main="T2D PRS Score Analysis")
lines(density(std_score, adjust=2), col="darkblue")
...
plot(quan_cases.df[,1], quan_cases.df[,2]*adj, xlab="Standardized PRS score", ylab=paste0("Pred Odds (x", adj, ")"), xlim=c(-4.5, 4.5), ylim=c(0,0.4), main="T2D PRS Score Analysis")
lines(density(std_score, adjust=2), col="darkblue")
...
#----------------------- Logistic Regression, White for cutoff ------------------------------
setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/t2d_0.95")
score_pheno <- read.table("prs_score_t2d_covariates_chip.tsv", header=T, stringsAsFactors=F)

white_score_pheno <- score_pheno[score_pheno[,7]=="White",]

all_score <- white_score_pheno[,3]
std_score <- (all_score - mean(all_score))/sd(all_score)  #calculate standardized PRS scores
white_score_pheno$std_score <- std_score   #Add standardized PRS into all_prs table

mylogit <- glm(T2DM95~std_score+Gender+Age+chip, data=white_score_pheno, family=binomial)  #Build model
summary(mylogit)   #View the model
confint(mylogit)         #confident interval of predictors
...
OR_change_per_prs_sd <- exp(std_score_coef)
OR_change_per_prs_sd
std_threshold <- log(2) / log(OR_change_per_prs_sd)   #2 is target raw PRS score cutoff
std_threshold
...
title(xlab="Standardized PRS score", line=2, cex.lab=1.0)
title(ylab=paste0("predicted odds (x", adj, ")"), line=2, cex.lab=1.0)
...
#----------------------- Logistic Regression, non-White------------------------------
setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/t2d_0.95")
score_pheno <- read.table("prs_score_t2d_covariates_chip.tsv", header=T, stringsAsFactors=F)

non_white_score_pheno <- score_pheno[score_pheno[,7]!="White",]

all_score <- non_white_score_pheno[,3]
std_score <- (all_score - mean(all_score))/sd(all_score)  #calculate standardized PRS scores
non_white_score_pheno$std_score <- std_score   #Add standardized PRS into all_prs table

mylogit <- glm(T2DM95~std_score+Gender+Age+chip, data=non_white_score_pheno, family=binomial)  #Build model
summary(mylogit)   #View the model
confint(mylogit)         #confident interval of predictors
...
new_data <- non_white_score_pheno
pred <- predict(mylogit, newdata=new_data)
pred_odds <- exp(pred)
#plot(std_score, pred_odds)
...
#Plot density and predicted odds 
adj <- 0.5     #scale to match density
pred_odds.adj <- pred_odds * adj
...
#Deansity plot
plot(density(white_score, adjust=2), col="black", xlim=c(55, 56.7), ylim=c(0, 3), xlab="PRS score", lty="dotted", main="Density ~ PRS score of T2D")

par(mar=c(3.5,3.5,1,1))
plot(density(white_score, adjust=2), col="black", xlim=c(55.1, 56.8), ylim=c(0, 3.2), xlab="", ylab="", lty="dotted", main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab="Density", line=2, cex.lab=1.0)
...
#what percentage >cutoff in white
num_gt_threshold <- sum(white_score > 55.88877)
white_gt_threshold_percentage <- num_gt_threshold / length(white_score) *100
white_gt_threshold_percentage
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(55, 56.7), ylim=c(0, 3), main="White T2D PRS Score Analysis")

par(mar=c(3.5,3.5,1,1))
plot(prs_score, odds.adj, xlab="", ylab="", xlim=c(55, 56.7), ylim=c(0, 3), main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
...
corr
text(56.2, 2.7, paste0("r=", round(corr,4)))
...
prs_score <- quan_cases.df[,1]
odds <- quan_cases.df[,4]
adj <- 4     #scale to match density
odds.adj <- odds * adj

plot(prs_score, odds.adj)

plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(55, 56.7), ylim=c(0, 2.0), main="White T2D PRS Score Analysis")

par(mar=c(3.5,3.5,1,1))
plot(prs_score, odds.adj, xlab="", ylab="", xlim=c(55, 56.7), ylim=c(0, 2.0), main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab=paste0("Odds (x", adj, ")"), line=2, cex.lab=1.0)
...
corr <- cor(quan_cases.df[,1], quan_cases.df[,4], method="spearman")  #Rank based corelation test
corr
text(56.4, 1.8, paste0("r=", round(corr,4)))
...
#what percentage >cutoff in white
num_gt_threshold <- sum(black_score > 55.88877)
black_gt_threshold_percentage <- num_gt_threshold / length(black_score) *100
black_gt_threshold_percentage
...
prs_score <- quan_cases.df[,1]
odds <- quan_cases.df[,4]
adj <- 2     #scale to match density
odds.adj <- odds * adj

plot(prs_score, odds.adj)

plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(55, 56.7), ylim=c(0, 3), main="Black T2D PRS Score Analysis")

par(mar=c(3.5,3.5,1,1))
plot(prs_score, odds.adj, xlab="", ylab="", xlim=c(55.3, 57.0), ylim=c(0, 3.5), main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab=paste0("Odds (x", adj, ")"), line=2, cex.lab=1.0)
...
abline(lm(odds.adj~prs_score), col="red")
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(56.65, 2.5, paste0("r=", round(corr,4)))
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(55, 56.7), ylim=c(0, 3), main="Asian T2D PRS Score Analysis")
...
abline(lm(odds.adj~prs_score), col="red")
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(56.6, 2.5, paste0("r=", round(corr,4)))
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(55, 56.7), ylim=c(0, 3), main="Other T2D PRS Score Analysis")

par(mar=c(3.5,3.5,1,1))
plot(prs_score, odds.adj, xlab="", ylab="", xlim=c(55.1, 56.6), ylim=c(0, 3.2), main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab=paste0("Odds (x", adj, ")"), line=2, cex.lab=1.0)
...
abline(lm(odds.adj~prs_score), col="red")
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(56.3, 2.8, paste0("r=", round(corr,4)))
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"),xlim=c(55, 56.7), ylim=c(0, 3), main="Unknown T2D PRS Score Analysis")

par(mar=c(3.5,3.5,1,1))
plot(prs_score, odds.adj, xlab="", ylab="", xlim=c(55.0, 56.7), ylim=c(0, 3.0), main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab=paste0("Odds (x", adj, ")"), line=2, cex.lab=1.0)
...
abline(lm(odds.adj~prs_score), col="red")
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(56.3, 2.5, paste0("r=", round(corr,4)))
...
mylogit <- glm(T2DM95~std_score+Age+chip, data=white_score_pheno, family=binomial)  #Build model
summary(mylogit)   #View the model
#confint(mylogit)         #confident interval of predictors
...
#std_threshold = 1.691731

### Obtain std_threshold from literature at OR>2
std_threshold = 1.38
...
score_pheno_pc_control <- score_pheno_pc[which(score_pheno_pc$T2DM95 == 0),]

pcmod <- lm(PRS ~ PC1 + PC2 + PC3 + PC4, data=score_pheno_pc_control)
summary(pcmod)
saveRDS(pcmod, "t2d_pc_model.RDS")
...
#write.csv(high.risk, file="above_cutoff_t2d.csv", row.names=F, quote=F)
...
text(3.8, 0.3, paste0("cutoff=", round(all_std_resid_threshold,2)), cex = 0.7)
...
plot(density(white_std_raw_score, adjust=2), col="black", xlim=c(-5, 5), ylim=c(0, 0.6), xlab="PRS score", lty="solid", main="Density ~ PRS score of CAD")
...
text(4, 0.2, paste0("cutoff=", round(all_std_raw_threshold,2)), cex = 0.7)
...
nr <- length(Vars) 
legend("topright", rep(Vars, 1), col = colors, lty = ltys, ncol = 1, cex = 0.40)
...
#write.csv(above_cutoff.adj, file="high_risk_analysis/above_cutoff_t2d.csv", row.names=F, quote=F)
...
text(-3.25, -0.5, paste0("T2D"))
text(-3.15, -1, paste0("Black"))
...
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(2.7, -4, paste0("r=", round(corr,4)))

text(-3.2, -0.5, paste0("T2D"))
text(-3.1, -1, paste0("Asian"))
text(-3.1, -1.6, paste0("q=", quan))
...
pc_model <- readRDS("t2d_pc_model.RDS")
sample_raw_score <- read.table("pre_GDA_test_merged_large_batch_cleaned_imputed_T2D_22samples.sscore", header=F, stringsAsFactor=F)
output_name <- "pre_GDA_test_merged_large_batch_cleaned_imputed_T2D_22samples.sscore.adjusted"
...
#Read in each batch to get the subjects for each batch
mega_profile <- read.table("mega_t2d.profile", header=F, stringsAsFactors=F)
megaex_profile <- read.table("megaex_t2d.profile", header=F, stringsAsFactors=F)
mega1a_profile <- read.table("meg_a1_a_t2d.profile", header=F, stringsAsFactors=F)
mega1b_profile <- read.table("meg_a1_b_t2d.profile", header=F, stringsAsFactors=F)
megc_profile <- read.table("meg_c_t2d.profile", header=F, stringsAsFactors=F)
megd_profile <- read.table("meg_d_t2d.profile", header=F, stringsAsFactors=F)
mege_profile <- read.table("meg_e_t2d.profile", header=F, stringsAsFactors=F)
megx1_profile <- read.table("meg_x1_t2d.profile", header=F, stringsAsFactors=F)
