setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/prostate")

#------------------- Read in data -----------------------

mega_profile <- read.table("mega_prostate_male.profile", header=T, stringsAsFactors=F)
megaex_profile <- read.table("megaex_prostate_male.profile", header=T, stringsAsFactors=F)
mega1a_profile <- read.table("meg_a1_a_prostate_male.profile", header=T, stringsAsFactors=F)
mega1b_profile <- read.table("meg_a1_b_prostate_male.profile", header=T, stringsAsFactors=F)
megc_profile <- read.table("meg_c_prostate_male.profile", header=T, stringsAsFactors=F)
megd_profile <- read.table("meg_d_prostate_male.profile", header=T, stringsAsFactors=F)
mege_profile <- read.table("meg_e_prostate_male.profile", header=T, stringsAsFactors=F)
megx1_profile <- read.table("meg_x1_prostate_male.profile", header=T, stringsAsFactors=F)
...
all_batch_profile <- read.table("all_batch_male.profile", header=T, stringsAsFactors=F)
...
output <- "~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/alldiseases_prs_top0.5/prostateCA_top0.5.csv"
...
plot(density(mega_score, adjust=2), col="black", xlim=c(8, 16), ylim=c(0, 0.6), xlab="PRS score", lty="dotted", main="Density ~ PRS score of prostateCA in Male")

par(mar=c(3.5,3.5,1,1))
plot(density(mega_score, adjust=2), col="black", xlim=c(8, 16), ylim=c(0, 0.6), xlab="",ylab="", lty="dotted", main="")
...
setwd("~/Documents/PRS_Jason/prs_analysis/1kg_imputed_normalized/prostate")
score_pheno <- read.table("prs_score_prostate_covariates_chip_male.tsv", header=T, stringsAsFactors=F)
...
plot(density(age20_score, adjust=2), col="black", xlim=c(8, 16), ylim=c(0, 0.6), xlab="PRS score", lty="dotted", main="Density ~ PRS score of prostateCA in Male")

par(mar=c(3.5,3.5,1,1))
plot(density(age30_score, adjust=2), col="black", xlim=c(8, 16), ylim=c(0, 0.6), xlab="", ylab="", lty="dotted", main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab="Density", line=2, cex.lab=1.0)
...
nr <- length(Vars) 
legend("topright", rep(Vars, 1), col = colors, lty = ltys, ncol = 1, cex = 0.52)
...
#Deansity plot
plot(density(white_score, adjust=2), col="black", xlim=c(8, 16), ylim=c(0, 0.6), xlab="PRS score", lty="dotted", main="Density ~ PRS score of ProstateCA")

par(mar=c(3.5,3.5,1,1))
plot(density(white_score, adjust=2), col="black", xlim=c(8, 16), ylim=c(0, 0.6), xlab="",ylab="", lty="dotted", main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
title(ylab="Density", line=2, cex.lab=1.0)
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(8, 16), ylim=c(0, 0.6), main="Male prostateCA PRS Score Analysis")
...
text(14, 0.5, paste0("r=", round(corr,4)))
...
plot(std_score, odds.adj, xlab="Standardized PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(-4, 4), ylim=c(0,0.6), main="Male prostateCA PRS Score Analysis")
lines(density(std_score, adjust=2), col="darkblue")
abline(lm(odds.adj~std_score), col="red")
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(2.5, 0.5, paste0("r=", round(corr, 4)))
...
mylogit <- glm(PRCA~std_score+Age+Race+chip, data=score_pheno, family=binomial)  #Build model
...
plot(std_score, pred_odds*adj, xlab="Standardized PRS score", ylab=paste0("predicted odds (x", adj, ")"), xlim=c(-4.5, 4.5), ylim=c(0,2.5), main="Male prostateCA PRS Score Analysis")
lines(density(std_score, adjust=2), col="darkblue")
...
plot(quan_cases.df[,1], quan_cases.df[,2]*adj, xlab="Standardized PRS score", ylab=paste0("Pred Odds (x", adj, ")"), xlim=c(-4.5, 4.5), ylim=c(0,0.5), main="Male prostateCA PRS Score Analysis")
...
plot(density(white_score, adjust=2), col="black", xlim=c(6.9, 14.4), ylim=c(0, 0.65), xlab="PRS score", lty="dotted", main="Density ~ PRS score of ProstateCA")
lines(density(black_score, adjust=2), lty="dotted", col="purple")
lines(density(asian_score, adjust=2), lty="dotted", col="green")
lines(density(other_score, adjust=2), lty="dotted", col="red")
lines(density(unknown_score, adjust=2), lty="dotted", col="blue")
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(8, 16), ylim=c(0, 0.6), main="White Male prostateCA PRS Score Analysis")

par(mar=c(3.5,3.5,1,1))
plot(prs_score, odds.adj, xlab="", ylab="", xlim=c(8, 16), ylim=c(0, 0.6), main="")
title(xlab="PRS score", line=2, cex.lab=1.0)
...
corr
text(14.5, 0.25, paste0("r=", round(corr,4)))  #Use spearman result, looking larger than kendall result
...
corr <- cor(quan_cases.df[,1], quan_cases.df[,4], method="spearman")  #Rank based corelation test
corr
text(14.3, 0.3, paste0("r=", round(corr,4)))
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(8, 16), ylim=c(0, 0.6), main="Black Male prostateCA PRS Score Analysis")
...
abline(lm(odds.adj~prs_score), col="red")
corr <- cor(quan_cases.df[,1], quan_cases.df[,4])
text(13, 0.5, paste0("r=", round(corr,4)))
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(8, 16), ylim=c(0, 0.6), main="Asian Male prostateCA PRS Score Analysis")
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(8, 16), ylim=c(0, 0.6), main="Other Male prostateCA PRS Score Analysis")
...
plot(prs_score, odds.adj, xlab="PRS score", ylab=paste0("Odds (x", adj, ")"), xlim=c(8, 16), ylim=c(0, 0.6), main="Unknown Male prostateCA PRS Score Analysis")
...
mylogit <- glm(PRCA~std_score+Age+chip, data=white_score_pheno, family=binomial)  #Build model
summary(mylogit)   #View the model
#confint(mylogit)         #confident interval of predictors
...
score_pheno_pc_control <- score_pheno_pc[which(score_pheno_pc$PRCA == 0),]

pcmod <- lm(PRS ~ PC1 + PC2 + PC3 + PC4, data=score_pheno_pc_control)
summary(pcmod)
saveRDS(pcmod, "prostateC_pc_model.RDS")
...
#write.csv(high.risk, file="above_cutoff_pc.csv", row.names=F, quote=F)
...
text(3.6, 0.2, paste0("cutoff=", round(all_std_raw_threshold,2)), cex = 0.7)
...
#write.csv(above_cutoff.adj, file="high_risk_analysis/above_cutoff_pc.csv", row.names=F, quote=F)
...
pc_model <- readRDS("prostateC_pc_model.RDS")
sample_raw_score <- read.table("pre_GDA_test_merged_large_batch_cleaned_imputed_ProstateCA_22samples.sscore", header=F, stringsAsFactor=F)
output_name <- "pre_GDA_test_merged_large_batch_cleaned_imputed_ProstateCA_22samples.sscore.adjusted"
...
mega_profile <- read.table("mega_prostate_male.profile", header=F, stringsAsFactors=F)
megaex_profile <- read.table("megaex_prostate_male.profile", header=F, stringsAsFactors=F)
mega1a_profile <- read.table("meg_a1_a_prostate_male.profile", header=F, stringsAsFactors=F)
mega1b_profile <- read.table("meg_a1_b_prostate_male.profile", header=F, stringsAsFactors=F)
megc_profile <- read.table("meg_c_prostate_male.profile", header=F, stringsAsFactors=F)
megd_profile <- read.table("meg_d_prostate_male.profile", header=F, stringsAsFactors=F)
mege_profile <- read.table("meg_e_prostate_male.profile", header=F, stringsAsFactors=F)
megx1_profile <- read.table("meg_x1_prostate_male.profile", header=F, stringsAsFactors=F)

#Read in score_pheno table
score_pheno <- read.table("prs_score_prostate_covariates_chip_male.tsv", header=T, stringsAsFactors=F)

#Prepare adjusted PCR scores
setwd("~/Documents/PRS_Jason/Cutoff_adjustment/PCA_adjustment_MDS")
pc <- read.table("plink2pca/ref_pcs.eigenvec.newid", header=T, stringsAsFactor=F)
